...
export class ResponseValidator {
     ...
     * @since 1.0.0
     */
    constructor(config, maxLogSize = 10_000) {
     ...
     * @since 1.0.0
     */
    async attest(sessionId, method, params, response, slot) {
     ...
     * @since 1.0.0
     */
    async wrapResult(data, sessionId, method, params, slot, latencyMs, callIndex, shouldAttest) {
        const result = {
            data,
            latencyMs,
            callIndex,
     ...
     * @since 1.0.0
     */
    static verifyIntegrity(attestation, params, response) {
        const requestHash = sha256(canonicalize(params));
        const responseHash = sha256(canonicalize(response));
        return {
     ...
     * @since 1.0.0
     */
    static async verifySignature(attestation, verifier, attesterPubkey) {
     ...
     * @since 1.0.0
     */
    getSessionAttestations(sessionId) {
     ...
     * @since 1.0.0
     */
    getMethodAttestations(method, limit = 100) {
