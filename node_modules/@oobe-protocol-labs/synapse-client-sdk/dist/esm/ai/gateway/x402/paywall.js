 ...
 * @since 1.0.0
 */
import { X402_HEADER_PAYMENT_REQUIRED, X402_HEADER_PAYMENT_SIGNATURE, X402_STATUS_CODE, X402_VERSION, } from './types.js';
 ...
 * @since 1.0.0
 */
export function encodePaymentHeader(obj) {
 ...
 * @since 1.0.0
 */
export function decodePaymentHeader(base64) {
