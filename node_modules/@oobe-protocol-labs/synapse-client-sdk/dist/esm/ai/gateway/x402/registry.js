 ...
 * @since 1.0.0
 */
import { KnownFacilitator, X402ProtocolVersion, SOLANA_MAINNET, SOLANA_DEVNET, BASE_MAINNET, BASE_SEPOLIA, ETHEREUM_MAINNET, POLYGON_MAINNET, AVALANCHE_MAINNET, SEI_MAINNET, } from './types.js';
/* ═══════════════════════════════════════════════════════════════
 ...
 * @since 1.0.0
 */
export const FACILITATOR_REGISTRY = new Map([
    /* ── PayAI ─────────────────────────────────────────────── */
    [
 ...
 * @since 1.0.0
 */
export function getFacilitatorInfo(facilitator) {
 ...
 * @since 1.0.0
 */
export function findFacilitatorsByNetwork(network) {
    const results = [];
 ...
 * @since 1.0.0
 */
export function findGasSponsoredFacilitators() {
    const results = [];
    for (const info of FACILITATOR_REGISTRY.values()) {
 ...
 * @since 1.0.0
 */
export function listKnownFacilitators() {
 ...
 * @since 1.0.0
 */
export function resolveKnownFacilitator(facilitator, overrides) {
