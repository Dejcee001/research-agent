 ...
 * @since 1.0.0
 */
export function createMethodRegistry(protocol) {
    const methods = [];
 ...
 * @since 1.0.0
 */
export function buildProtocolTools(methods, execute, opts = {}) {
