...
const zRaydiumProgram = z.enum([
    ...
    'acceleraytor',
    'clmm_legacy',
]).describe('Raydium program name. amm_v4 is the classic AMM. clmm is Concentrated Liquidity Market Maker. ' +
 ...
 * ═══════════════════════════════════════════════════════════════ */
register('fetchAccount', z.object({
...
}), zAccountInfoResult, 'Fetch raw on-chain account data for any Solana address. ' +
...
register('searchProgramAccounts', z.object({
 ...
 * ═══════════════════════════════════════════════════════════════ */
register('getTransactionHistory', z.object({
    ...
    commitment: zCommitment,
}), z.array(zSignatureEntry), 'Get recent transaction signatures for a Raydium program address, pool account, or wallet. ' +
...
register('inspectTransaction', z.object({
 ...
 *  3. Pool state
 * ═══════════════════════════════════════════════════════════════ */
register('getPoolState', z.object({
...
register('getMultiplePoolStates', z.object({
...
register('getPoolsByMint', z.object({
    ...
    mintOffset: z.number().int().min(0)
        .describe('Byte offset of the mint field in the pool account data layout. ' +
 ...
 * ═══════════════════════════════════════════════════════════════ */
register('getLPPositions', z.object({
...
register('getFarmPositions', z.object({
 ...
 *  5. Program registry
 * ═══════════════════════════════════════════════════════════════ */
register('resolvePrograms', z.object({}), z.object({
 ...
 * @since 1.1.0
 */
export const raydiumOnchainMethodNames = methods.map((m) => m.name);
