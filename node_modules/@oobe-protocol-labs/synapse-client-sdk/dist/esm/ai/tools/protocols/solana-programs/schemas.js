 ...
 * ═══════════════════════════════════════════════════════════════ */
register('systemTransfer', z.object({
...
register('systemCreateAccount', z.object({
...
register('systemAllocate', z.object({
...
register('systemAssign', z.object({
 ...
 * ═══════════════════════════════════════════════════════════════ */
register('tokenTransfer', z.object({
...
register('tokenTransferChecked', z.object({
    source: zPubkey.describe('Source token account'),
...
register('tokenApprove', z.object({
...
register('tokenCloseAccount', z.object({
...
register('ataCreateIdempotent', z.object({
    payer: zPubkey.describe('Payer for account creation (signer)'),
    associatedToken: zPubkey.describe('The ATA address (derived deterministically)'),
 ...
 * ═══════════════════════════════════════════════════════════════ */
register('setComputeUnitLimit', z.object({
...
register('setComputeUnitPrice', z.object({
