...
const zJupiterProgram = z.enum([
    ...
    'vote',
    'dao',
]).describe('Jupiter program name. aggregator_v6 is the current swap router. ' +
...
register('getTransactionHistory', z.object({
    ...
    commitment: zCommitment,
}), z.array(zSignatureEntry), 'Get recent transaction signatures for a Jupiter program address, wallet, or any on-chain account. ' +
...
register('getDCAAccounts', z.object({
...
register('getPerpsPositions', z.object({
 ...
 *  4. Token utilities
 * ═══════════════════════════════════════════════════════════════ */
register('getTokenMintInfo', z.object({
...
register('getTokenHoldings', z.object({
 ...
 * @since 1.1.0
 */
export const jupiterOnchainMethodNames = methods.map((m) => m.name);
