...
regSns('registerDomain', z.object({
    wallet: zPubkey,
...
regDomains('registerDomain', z.object({
    wallet: zPubkey,
...
regDomains('resolveDomain', z.object({
...
regDomains('getOwnedDomains', z.object({
    wallet: zPubkey,
...
regPyth('getPriceHistory', z.object({
    priceId: z.string(),
...
regPyth('listPriceFeeds', z.object({
...
regGecko('getTokenPrice', z.object({
...
regGecko('getTrending', z.object({}), z.object({
...
regGecko('getTopGainersLosers', z.object({
    vsCurrency: z.string().optional().default('usd'),
...
regGecko('getTokenInfo', z.object({
...
regGecko('getPoolsByToken', z.object({
 ...
 *  Exports
 * ═══════════════════════════════════════════════════════════════ */
export { snsMethods, alldomainsMethods, pythMethods, coingeckoMethods, gibworkMethods, sendArcadeMethods, };
