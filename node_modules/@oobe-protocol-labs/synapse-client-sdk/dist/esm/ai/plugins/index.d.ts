...
export type { SynapsePlugin, PluginMeta, PluginProtocol, PluginContext, PluginExecutor, PluginInstallResult, InstalledPlugin, AgentKitConfig, McpToolDescriptor, McpResourceDescriptor, } from './types';
