...
regBlinks('executeAction', z.object({
...
regBlinks('confirmAction', z.object({
...
regBlinks('resolveBlinkUrl', z.object({
...
regBlinks('validateActionsJson', z.object({
...
regBlinks('buildActionUrl', z.object({
...
export const allBlinksMethods = [...blinksMethods];
