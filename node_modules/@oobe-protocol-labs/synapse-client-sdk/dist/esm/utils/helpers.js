import { Lamports as mkLamports } from '../core/types.js';
/**
 ...
 * ```
 */
export const solToLamports = (sol) => mkLamports(Math.round(sol * 1e9));
/**
 ...
 * @since 1.0.0
 */
export const isValidPubkey = (s) => /^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(s);
/**
 ...
 * @since 1.0.0
 */
export const isValidSignature = (s) => /^[1-9A-HJ-NP-Za-km-z]{87,88}$/.test(s);
/**
 ...
 * ```
 */
export async function retry(fn, maxAttempts = 3, baseDelayMs = 500) {
    let lastErr;
 ...
 * ```
 */
export function createSingleton(key, factory, options) {
