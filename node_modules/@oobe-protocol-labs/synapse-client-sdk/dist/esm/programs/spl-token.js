...
import { InstructionWriter, writableSigner, writable, readonly, readonlySigner } from './types.js';
// ── Program IDs ────────────────────────────────────────────────
/**
...
function ownerKeys(owner, multiSigners, ownerWritable = false) {
...
export const SplToken = {
    ...
    initializeAccount(p) {
        ...
        w.u8(1 /* TokenIx.InitializeAccount */);
        return {
            programId: pid,
            keys: [
                writable(p.account),
    ...
    transferChecked(p) {
        ...
        w.u8(12 /* TokenIx.TransferChecked */);
        w.u64(p.amount);
        w.u8(p.decimals);
        return {
            programId: pid,
    ...
    approveChecked(p) {
        const pid = p.programId ?? TOKEN_PROGRAM;
        const w = new InstructionWriter(10);
        w.u8(13 /* TokenIx.ApproveChecked */);
        w.u64(p.amount);
        w.u8(p.decimals);
        return {
            programId: pid,
