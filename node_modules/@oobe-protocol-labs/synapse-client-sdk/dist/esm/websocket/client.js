...
const getWsConstructor = () => {
    ...
    try {
        ...
        throw new Error('No WebSocket implementation found. Install the "ws" package for Node.js: pnpm add ws');
    }
};
/**
...
export class WsClient {
     ...
     * @since 1.0.0
     */
    onAccountChange(pubkey, handler, opts = {}) {
     ...
     * @since 1.0.0
     */
    onProgramAccountChange(programId, handler, opts = {}) {
     ...
     * @since 1.0.0
     */
    onSignature(signature, handler, opts = {}) {
    ...
    connect() {
        return new Promise((resolve, reject) => {
            ...
            const ws = new WsCtor(this.cfg.endpoint);
            this.ws = ws;
