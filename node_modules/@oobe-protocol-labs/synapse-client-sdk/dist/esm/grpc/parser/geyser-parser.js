...
import { parseGeyserUpdate, parseTransaction, parseAccountUpdate, parseSlotUpdate, parseBlockMeta, parseEntry, } from './decoder.js';
/* ═══════════════════════════════════════════════════════════════
 *  GeyserParser class
 * ═══════════════════════════════════════════════════════════════ */
/**
 ...
 * @since 1.0.0
 */
export class GeyserParser extends EventEmitter {
    _config;
    _stats;
    constructor(config = {}) {
        super();
