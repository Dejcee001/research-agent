 ...
 * ═══════════════════════════════════════════════════════════════ */
export { SYSTEM_PROGRAMS, SPL_PROGRAMS, JUPITER_PROGRAMS, RAYDIUM_PROGRAMS, METEORA_PROGRAMS, ORCA_PROGRAMS, METAPLEX_PROGRAMS, MARINADE_PROGRAMS, OTHER_PROGRAMS, };
/* ═══════════════════════════════════════════════════════════════
 *  Lookup helpers
 * ═══════════════════════════════════════════════════════════════ */
/**
 ...
 * @since 1.0.0
 */
export function resolveProgram(programId, custom) {
 ...
 * @since 1.0.0
 */
export function resolveProgramBatch(programIds, custom) {
 ...
 * @since 1.0.0
 */
export function isProgramInCategory(programId, category) {
    const registries = {
 ...
 * @since 1.0.0
 */
export function getProgramCategory(programId) {
