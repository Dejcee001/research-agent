...
export { 
// Token creation
createToken, isDisposable, 
// Error classes
ServiceNotFoundError, CircularDependencyError, AsyncProviderError, } from './types.js';
// ── Container ──────────────────────────────────────────────────
export { SynapseContext } from './container.js';
// ── Memory-safe references ─────────────────────────────────────
export { ServiceRef, WeakServiceRef, RefRegistry, MemoryGuard, RefReleasedError, createBinding, } from './refs.js';
// ── Built-in providers & tokens ────────────────────────────────
export { Tokens, createSynapseContext, createBareContext, } from './providers.js';
// ── Hooks & adapters ───────────────────────────────────────────
export { 
// Global context
setGlobalContext, getContext, tryGetContext, 
// Service accessors
useService, tryUseService, createServiceHook, createBoundHook, 
// Memory-safe ref hooks
useSharedRef, useBoundServices, withRef, withRefAsync, createRefHook, 
// Framework adapters
createReactAdapter, createServerMiddleware, autoWire, } from './hooks.js';
