import * as m from './methods/index.js';
/**
...
export class DasClient {
     ...
     * @since 1.0.0
     */
    getAssetsByCreator(params, opts) {
     ...
     * @since 1.0.0
     */
    getAssetsByAuthority(params, opts) {
     ...
     * @since 1.0.0
     */
    getSignaturesForAsset(params, opts) {
