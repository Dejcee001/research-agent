 ...
 * @since 1.0.0
 */
export declare function getAssetsByAuthority(t: HttpTransport, params: GetAssetsByAuthorityParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
//# sourceMappingURL=get-assets-by-authority.d.ts.map