 ...
 * @since 1.0.0
 */
export declare function getFeeForMessage(t: HttpTransport, message: string, commitment?: Commitment, opts?: CallOptions & {
    minContextSlot?: number;
}): Promise<RpcContext<number | null>>;
//# sourceMappingURL=get-fee-for-message.d.ts.map