 ...
 * @since 1.0.0
 */
export declare function requestAirdrop(t: HttpTransport, pubkey: Pubkey, lamports: number, commitment?: Commitment, opts?: CallOptions): Promise<Signature>;
//# sourceMappingURL=request-airdrop.d.ts.map