 ...
 * @since 1.0.0
 */
export declare function getSlotLeaders(t: HttpTransport, startSlot: Slot, limit: number, opts?: CallOptions): Promise<Pubkey[]>;
//# sourceMappingURL=get-slot-leaders.d.ts.map