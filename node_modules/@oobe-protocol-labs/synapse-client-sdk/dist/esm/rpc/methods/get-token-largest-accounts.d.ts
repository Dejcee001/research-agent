 ...
 * @since 1.0.0
 */
export declare function getTokenLargestAccounts(t: HttpTransport, mint: Pubkey, commitment?: Commitment, opts?: CallOptions): Promise<RpcContext<{
    address: Pubkey;
    amount: string;
    decimals: number;
...
//# sourceMappingURL=get-token-largest-accounts.d.ts.map