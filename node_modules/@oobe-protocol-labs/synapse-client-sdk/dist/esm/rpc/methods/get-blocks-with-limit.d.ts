 ...
 * @since 1.0.0
 */
export declare function getBlocksWithLimit(t: HttpTransport, startSlot: Slot, limit: number, commitment?: Commitment, opts?: CallOptions): Promise<Slot[]>;
//# sourceMappingURL=get-blocks-with-limit.d.ts.map