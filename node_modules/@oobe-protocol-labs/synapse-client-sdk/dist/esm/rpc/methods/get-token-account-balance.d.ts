 ...
 * @since 1.0.0
 */
export declare function getTokenAccountBalance(t: HttpTransport, tokenAccount: Pubkey, commitment?: Commitment, opts?: CallOptions): Promise<RpcContext<TokenAmount>>;
//# sourceMappingURL=get-token-account-balance.d.ts.map