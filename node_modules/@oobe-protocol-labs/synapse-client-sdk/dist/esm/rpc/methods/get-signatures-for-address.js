 ...
 * @since 1.0.0
 */
export async function getSignaturesForAddress(t, address, opts = {}) {
    ...
    for (let page = 0; page < maxPages && remaining > 0; page++) {
        ...
        const batch = await t.request('getSignaturesForAddress', [address, cfg], rest);
...
//# sourceMappingURL=get-signatures-for-address.js.map