 ...
 * @since 1.0.0
 */
export declare function getTokenSupply(t: HttpTransport, mint: Pubkey, commitment?: Commitment, opts?: CallOptions): Promise<RpcContext<TokenAmount>>;
//# sourceMappingURL=get-token-supply.d.ts.map