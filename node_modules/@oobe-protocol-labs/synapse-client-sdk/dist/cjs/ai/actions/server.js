...
exports.ActionServer = exports.ActionServerError = void 0;
/* ═══════════════════════════════════════════════════════════════
 *  Error
 * ═══════════════════════════════════════════════════════════════ */
/**
...
class ActionServerError extends Error {
    statusCode;
    code;
    constructor(message, statusCode = 400, code = 'ACTION_ERROR') {
        super(message);
...
exports.ActionServerError = ActionServerError;
/* ═══════════════════════════════════════════════════════════════
 *  ActionServer
 * ═══════════════════════════════════════════════════════════════ */
/**
                ...
                if (action.parameters) {
                    for (const param of action.parameters) {
                        if (param.required !== false && !params[param.name]) {
                            return this.corsResponse(this.jsonResponse({ error: `Missing required parameter: '${param.name}'` }, 400));
                        }
                    }
                }
                // Build context
...
exports.ActionServer = ActionServer;
