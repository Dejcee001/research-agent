...
exports.BlinkGenerator = exports.ACTION_SCHEME = exports.DEFAULT_RESOLVER_URL = void 0;
exports.createBlinkFromAction = createBlinkFromAction;
/* ═══════════════════════════════════════════════════════════════
 *  Constants
 * ═══════════════════════════════════════════════════════════════ */
/**
 ...
 * @since 1.3.0
 */
exports.DEFAULT_RESOLVER_URL = 'https://dial.to';
/**
 * @description Solana Action URL scheme prefix.
 * @since 1.3.0
 */
exports.ACTION_SCHEME = 'solana-action:';
/* ═══════════════════════════════════════════════════════════════
 *  BlinkGenerator
 * ═══════════════════════════════════════════════════════════════ */
/**
...
class BlinkGenerator {
     ...
     */
    constructor(config) {
        this.resolverUrl = (config.resolverUrl ?? exports.DEFAULT_RESOLVER_URL).replace(/\/$/, '');
    ...
    createUrl(params) {
        ...
        blinkUrl.searchParams.set('action', `${exports.ACTION_SCHEME}${actionUrl}`);
...
exports.BlinkGenerator = BlinkGenerator;
/* ═══════════════════════════════════════════════════════════════
 ...
 * @since 1.3.0
 */
function createBlinkFromAction(action, serverConfig, blinkConfig) {
...
//# sourceMappingURL=blinks.js.map