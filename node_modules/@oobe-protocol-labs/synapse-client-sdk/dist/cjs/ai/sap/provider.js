...
exports.createSapProvider = createSapProvider;
exports.createSapContextBlueprint = createSapContextBlueprint;
 ...
 * ```
 */
function createSapProvider(wallet, config, opts) {
    const singletonOpts = {
        ...opts,
        ...(config?.version != null ? { version: Number(config.version) || 0 } : {}),
    };
    return (0, helpers_1.createSingleton)('__synapse_sap__', () => client_1.SynapseAnchorSap.create({ wallet, ...config }), singletonOpts);
}
/**
 ...
 * ```
 */
function createSapContextBlueprint(config) {
    const defaultValue = {
        client: null,
        loading: false,
        error: null,
    ...
    function createManager() {
        ...
        return {
            connect(wallet) {
                ...
                notify();
                try {
                    client = client_1.SynapseAnchorSap.create({ wallet, ...config });
                    loading = false;
                    notify();
                }
                catch (e) {
