...
exports.metaplexMethodNames = exports.metaplexMethods = void 0;
exports.createMetaplexTools = createMetaplexTools;
/**
 ...
 * ═══════════════════════════════════════════════════════════════ */
function createMetaplexExecutor(transport) {
 ...
 */
async function executeResolveCollection(transport, input) {
    const collectionAddress = input.collectionAddress;
    ...
    for (const item of items) {
        if (item?.ownership?.owner)
            owners.add(item.ownership.owner);
    ...
    return {
        collection,
        stats: {
            totalSupply: page?.total ?? items.length,
 ...
 * @since 1.0.0
 */
function createMetaplexTools(client, opts = {}) {
    const execute = createMetaplexExecutor(client.transport);
    return (0, shared_1.buildProtocolTools)(schemas_1.metaplexMethods, execute, {
...
Object.defineProperty(exports, "metaplexMethods", { enumerable: true, get: function () { return schemas_2.metaplexMethods; } });
Object.defineProperty(exports, "metaplexMethodNames", { enumerable: true, get: function () { return schemas_2.metaplexMethodNames; } });
