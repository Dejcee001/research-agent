...
exports.PricingEngine = exports.DEFAULT_TIERS = void 0;
/* ═══════════════════════════════════════════════════════════════
 *  Pre-built pricing tiers
 * ═══════════════════════════════════════════════════════════════ */
const SOL = { type: 'SOL' };
const USDC = { type: 'USDC' };
/**
...
exports.DEFAULT_TIERS = [
    ...
    },
    {
        id: 'standard',
        label: 'Standard',
        pricePerCall: 1000n, // 0.000001 SOL per call
    ...
    },
    {
        ...
        pricePerCall: 5000n, // 0.000005 SOL per call
...
class PricingEngine {
     ...
     * @since 1.0.0
     */
    constructor(defaultTiers = exports.DEFAULT_TIERS, methodTiers = {}, dynamicConfig = {}) {
     ...
     * @since 1.0.0
     */
    computeCallPrice(tier) {
        if (tier.pricePerCall === 0n)
            return 0n; // Free tier is always free
        ...
        if (this.avgLatencyMs > this.dynamicConfig.congestionThresholdMs) {
            const congestionRatio = Math.min(this.avgLatencyMs / this.dynamicConfig.congestionThresholdMs, this.dynamicConfig.congestionMaxMultiplier);
     ...
     * @since 1.0.0
     */
    estimateSessionCost(tierId, estimatedCalls, method) {
     ...
     * @since 1.0.0
     */
    computeBundleSessionCost(bundleId, tierId, estimatedCalls) {
