...
export declare const SOLANA_MAINNET: X402Network;
export declare const SOLANA_DEVNET: X402Network;
/** Well-known Solana token mints */
export declare const USDC_SOLANA_MAINNET = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
export declare const USDC_SOLANA_DEVNET = "4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU";
/** @deprecated Use USDC_SOLANA_MAINNET instead */
export declare const USDC_MAINNET = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
/** @deprecated Use USDC_SOLANA_DEVNET instead */
export declare const USDC_DEVNET = "4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU";
/** Well-known Base (Coinbase L2) network identifiers */
export declare const BASE_MAINNET: X402Network;
export declare const BASE_SEPOLIA: X402Network;
/** Well-known EVM network identifiers (additional) */
export declare const ETHEREUM_MAINNET: X402Network;
export declare const POLYGON_MAINNET: X402Network;
export declare const AVALANCHE_MAINNET: X402Network;
export declare const SEI_MAINNET: X402Network;
...
export declare const USDC_ETHEREUM_MAINNET = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48";
/** Canonical Permit2 proxy contract for x402 exact EVM scheme */
export declare const X402_PERMIT2_PROXY = "0x4020CD856C882D5fb903D99CE35316A085Bb0001";
/** All well-known Solana (SVM) networks */
export declare const SVM_NETWORKS: readonly [`${string}:${string}`, `${string}:${string}`];
/** All well-known EVM networks */
export declare const EVM_NETWORKS: readonly [`${string}:${string}`, `${string}:${string}`, `${string}:${string}`, `${string}:${string}`, `${string}:${string}`, `${string}:${string}`];
/**
 ...
 * @since 1.0.0
 */
export declare function isSvmNetwork(network: X402Network): boolean;
/**
 ...
 * @since 1.0.0
 */
export declare function isEvmNetwork(network: X402Network): boolean;
/**
 ...
 * ```
 */
export declare enum KnownFacilitator {
...
export declare enum EvmTransferMethod {
...
export declare enum X402ProtocolVersion {
...
export interface X402Config {
     ...
     */
    localVerifier?: (payload: X402PaymentPayload, requirements: X402PaymentRequirements) => Promise<X402VerifyResponse>;
}
export declare const X402_HEADER_PAYMENT_REQUIRED = "PAYMENT-REQUIRED";
export declare const X402_HEADER_PAYMENT_SIGNATURE = "PAYMENT-SIGNATURE";
export declare const X402_HEADER_PAYMENT_RESPONSE = "PAYMENT-RESPONSE";
export declare const X402_STATUS_CODE = 402;
