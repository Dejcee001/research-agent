 ...
 * @since 1.3.0
 */
export type IntentProtocol = 'jupiter' | 'raydium' | 'metaplex' | 'native' | 'marinade' | 'jito' | string;
/**
...
export interface IntentConfig {
     ...
     */
    protocolTools: Record<string, Record<string, {
...
export declare class IntentError extends Error {
     ...
     */
    constructor(message: string, code?: string, stepId?: string | undefined);
}
/**
 * @description Error thrown when a circular dependency is detected in the intent DAG.
 * @since 1.3.0
 */
export declare class CyclicDependencyError extends IntentError {
 ...
 * @since 1.3.0
 */
export declare class UnresolvedReferenceError extends IntentError {
 ...
 * @since 1.3.0
 */
export declare class BudgetExceededError extends IntentError {
