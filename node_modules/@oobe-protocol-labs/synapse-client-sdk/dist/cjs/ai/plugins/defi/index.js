...
exports.DeFiPlugin = exports.allDefiMethods = exports.jitoMethods = exports.luloMethods = exports.adrenaMethods = exports.driftMethods = exports.openbookMethods = exports.meteoraMethods = exports.manifestMethods = exports.orcaMethods = exports.raydiumPoolMethods = exports.pumpMethods = void 0;
const schemas_1 = require("./schemas");
var schemas_2 = require("./schemas");
Object.defineProperty(exports, "pumpMethods", { enumerable: true, get: function () { return schemas_2.pumpMethods; } });
Object.defineProperty(exports, "raydiumPoolMethods", { enumerable: true, get: function () { return schemas_2.raydiumPoolMethods; } });
Object.defineProperty(exports, "orcaMethods", { enumerable: true, get: function () { return schemas_2.orcaMethods; } });
Object.defineProperty(exports, "manifestMethods", { enumerable: true, get: function () { return schemas_2.manifestMethods; } });
Object.defineProperty(exports, "meteoraMethods", { enumerable: true, get: function () { return schemas_2.meteoraMethods; } });
Object.defineProperty(exports, "openbookMethods", { enumerable: true, get: function () { return schemas_2.openbookMethods; } });
Object.defineProperty(exports, "driftMethods", { enumerable: true, get: function () { return schemas_2.driftMethods; } });
Object.defineProperty(exports, "adrenaMethods", { enumerable: true, get: function () { return schemas_2.adrenaMethods; } });
Object.defineProperty(exports, "luloMethods", { enumerable: true, get: function () { return schemas_2.luloMethods; } });
Object.defineProperty(exports, "jitoMethods", { enumerable: true, get: function () { return schemas_2.jitoMethods; } });
Object.defineProperty(exports, "allDefiMethods", { enumerable: true, get: function () { return schemas_2.allDefiMethods; } });
/* ═══════════════════════════════════════════════════════════════
...
exports.DeFiPlugin = {
    meta: {
        id: 'defi',
        name: 'DeFi Plugin',
        description: 'DEX, AMM, perps, lending, yield, and MEV tools — ' +
    ...
    protocols: [
        ...
        },
        {
            id: 'raydium-pools',
            name: 'Raydium Pools',
            methods: schemas_1.raydiumPoolMethods,
            requiresClient: true,
        },
        {
            id: 'orca',
            name: 'Orca Whirlpool',
            methods: schemas_1.orcaMethods,
            baseUrl: ORCA_API,
            requiresClient: true,
        },
        {
            id: 'manifest',
            name: 'Manifest',
            methods: schemas_1.manifestMethods,
            requiresClient: true,
        },
        {
            id: 'meteora',
            name: 'Meteora',
            methods: schemas_1.meteoraMethods,
            requiresClient: true,
        },
        {
            id: 'openbook',
            name: 'Openbook',
            methods: schemas_1.openbookMethods,
            requiresClient: true,
        },
        {
            id: 'drift',
            name: 'Drift Protocol',
            methods: schemas_1.driftMethods,
            baseUrl: DRIFT_API,
            requiresClient: true,
        },
        {
            ...
            methods: schemas_1.adrenaMethods,
            requiresClient: true,
        },
        {
            id: 'lulo',
            name: 'Lulo',
            methods: schemas_1.luloMethods,
            baseUrl: LULO_API,
            requiresClient: true,
        },
        {
    ...
    install(context) {
        ...
        return {
            executor: async (method, input, ctx) => {
 ...
 * ═══════════════════════════════════════════════════════════════ */
// ── PumpPortal ─────────────────────────────────────────────────
async function executePump(transport, method, input) {
...
// ── Raydium Pools ──────────────────────────────────────────────
async function executeRaydiumPools(transport, method, input) {
...
// ── Orca Whirlpool ─────────────────────────────────────────────
async function executeOrca(transport, method, input) {
    switch (method.name) {
        case 'getWhirlpool': {
...
// ── Manifest ───────────────────────────────────────────────────
async function executeManifest(transport, method, input) {
    switch (method.name) {
        case 'getOrderbook': {
...
// ── Meteora ────────────────────────────────────────────────────
async function executeMeteora(transport, method, input) {
...
// ── Openbook ───────────────────────────────────────────────────
async function executeOpenbook(transport, method, input) {
    return {
        status: 'instruction_ready',
        protocol: 'openbook',
        method: method.name,
...
// ── Drift ──────────────────────────────────────────────────────
async function executeDrift(transport, method, input) {
    switch (method.name) {
        case 'getPositions': {
            ...
            const result = await transport.request('getProgramAccounts', [
                'dRiftyHA39MWEi3m9aunc5MzRF1JYuBsbn6VPcn33UH', // Drift program
                {
                    encoding: 'base64',
                    filters: [
                        { memcmp: { offset: 8, bytes: input.wallet } },
...
// ── Adrena ─────────────────────────────────────────────────────
async function executeAdrena(transport, method, input) {
    switch (method.name) {
        case 'getPositions': {
            const result = await transport.request('getProgramAccounts', [
...
// ── Lulo (FlexLend) ────────────────────────────────────────────
async function executeLulo(transport, method, input) {
    switch (method.name) {
        case 'getBestRates': {
            // Lulo FlexLend API — best rates aggregation
            try {
                const mint = input.mint ?? 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'; // USDC
        ...
        case 'getPositions': {
            try {
                const response = await fetch(`${LULO_API}/v1/positions?wallet=${input.wallet}`);
                if (!response.ok) {
...
// ── Jito ───────────────────────────────────────────────────────
async function executeJito(transport, method, input) {
    switch (method.name) {
        case 'sendBundle': {
            try {
...
exports.default = exports.DeFiPlugin;
