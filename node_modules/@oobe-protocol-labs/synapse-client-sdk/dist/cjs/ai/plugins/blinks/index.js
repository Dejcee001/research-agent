...
exports.BlinksPlugin = exports.allBlinksMethods = exports.blinksMethods = void 0;
const schemas_1 = require("./schemas");
var schemas_2 = require("./schemas");
Object.defineProperty(exports, "blinksMethods", { enumerable: true, get: function () { return schemas_2.blinksMethods; } });
Object.defineProperty(exports, "allBlinksMethods", { enumerable: true, get: function () { return schemas_2.allBlinksMethods; } });
/* ═══════════════════════════════════════════════════════════════
 *  Blinks Plugin
 * ═══════════════════════════════════════════════════════════════ */
exports.BlinksPlugin = {
    meta: {
        id: 'blinks',
        name: 'Blinks Plugin',
        description: 'Solana Actions / Blinks — discover, inspect, execute, and share on-chain actions via URL',
        version: '2.0.0',
    ...
    protocols: [
        {
            ...
            methods: schemas_1.blinksMethods,
            requiresClient: false,
        },
    ],
    install(context) {
        return {
            executor: async (method, input, _ctx) => {
...
async function executeBlinks(method, input) {
    try {
        switch (method.name) {
            /* ── GET Action Metadata ─────────────────────────────────── */
            case 'getAction': {
            ...
            case 'buildActionUrl': {
                ...
                const provider = input.blinkProvider ?? 'none';
                let blinkUrl;
                if (provider !== 'none') {
                    switch (provider) {
                        case 'dial.to':
...
exports.default = exports.BlinksPlugin;
