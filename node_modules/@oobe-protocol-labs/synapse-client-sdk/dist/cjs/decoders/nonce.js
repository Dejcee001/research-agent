...
exports.NONCE_ACCOUNT_SIZE = exports.SYSTEM_PROGRAM_ID = void 0;
exports.decodeNonceAccount = decodeNonceAccount;
const layout_1 = require("./layout");
// ── Constants ──────────────────────────────────────────────────
/** System Program ID. @since 1.1.0 */
exports.SYSTEM_PROGRAM_ID = '11111111111111111111111111111111';
/** Nonce account data size. @since 1.1.0 */
exports.NONCE_ACCOUNT_SIZE = 80;
// ── Decoder ────────────────────────────────────────────────────
/**
...
function decodeNonceAccount(data) {
    if (data.length < exports.NONCE_ACCOUNT_SIZE) {
        throw new Error(`Nonce account data too short: expected >= ${exports.NONCE_ACCOUNT_SIZE} bytes, got ${data.length}`);
    }
    const r = new layout_1.AccountReader(data);
    const version = r.u32(); // [0..4]
    const stateVal = r.u32(); // [4..8]
    const state = stateVal === 1 ? 'initialized' : 'uninitialized';
