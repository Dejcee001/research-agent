 ...
 * @since 1.0.0
 */
export declare function getSignatureStatuses(t: HttpTransport, signatures: Signature[], opts?: GetSignatureStatusesOpts): Promise<RpcContext<(SignatureStatus | null)[]>>;
//# sourceMappingURL=get-signature-statuses.d.ts.map