...
exports.getBlocksWithLimit = getBlocksWithLimit;
/**
 ...
 * @since 1.0.0
 */
async function getBlocksWithLimit(t, startSlot, limit, commitment = 'confirmed', opts = {}) {
    return t.request('getBlocksWithLimit', [startSlot, limit, { commitment }], opts);
}
//# sourceMappingURL=get-blocks-with-limit.js.map