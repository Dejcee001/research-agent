 ...
 * @since 1.0.0
 */
export declare function isBlockhashValid(t: HttpTransport, blockhash: string, commitment?: Commitment, opts?: CallOptions & {
    minContextSlot?: number;
}): Promise<RpcContext<boolean>>;
//# sourceMappingURL=is-blockhash-valid.d.ts.map