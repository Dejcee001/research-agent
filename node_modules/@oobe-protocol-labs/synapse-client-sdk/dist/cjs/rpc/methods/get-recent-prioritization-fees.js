...
exports.getRecentPrioritizationFees = getRecentPrioritizationFees;
/**
 ...
 * @since 1.0.0
 */
async function getRecentPrioritizationFees(t, addresses, opts = {}) {
    return t.request('getRecentPrioritizationFees', addresses ? [addresses] : [], opts);
}
//# sourceMappingURL=get-recent-prioritization-fees.js.map