...
exports.getTokenAccountsByDelegate = getTokenAccountsByDelegate;
/**
 ...
 * @since 1.0.0
 */
async function getTokenAccountsByDelegate(t, delegate, filter, opts = {}) {
    const { commitment = 'confirmed', minContextSlot, dataSlice, ...rest } = opts;
    const cfg = { commitment, encoding: 'jsonParsed' };
...
//# sourceMappingURL=get-token-accounts-by-delegate.js.map