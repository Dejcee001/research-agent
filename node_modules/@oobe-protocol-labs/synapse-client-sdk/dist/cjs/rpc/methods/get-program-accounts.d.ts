 ...
 * @since 1.0.0
 */
export declare function getProgramAccounts<D = string>(t: HttpTransport, programId: Pubkey, opts?: GetProgramAccountsOpts): Promise<ProgramAccount<D>[]>;
//# sourceMappingURL=get-program-accounts.d.ts.map