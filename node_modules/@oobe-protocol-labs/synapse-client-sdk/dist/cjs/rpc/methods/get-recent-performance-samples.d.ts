 ...
 * @since 1.0.0
 */
export declare function getRecentPerformanceSamples(t: HttpTransport, limit?: number, opts?: CallOptions): Promise<PerfSample[]>;
//# sourceMappingURL=get-recent-performance-samples.d.ts.map