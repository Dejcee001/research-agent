 ...
 * @since 1.0.0
 */
export declare function getMultipleAccounts<D = string>(t: HttpTransport, pubkeys: Pubkey[], opts?: GetMultipleAccountsOpts): Promise<RpcContext<(AccountInfo<D> | null)[]>>;
//# sourceMappingURL=get-multiple-accounts.d.ts.map