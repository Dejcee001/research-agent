...
export type LogsFilter = 'all' | 'allWithVotes' | {
    mentions: [Pubkey];
};
...
export type WsNotification = AccountNotification | ProgramNotification | LogsNotification | SignatureNotification | SlotNotification | RootNotification;
