...
import type { DasAsset, DasAssetProof, DasPage, DasSearchParams, DasOpts } from './types';
 ...
 * @since 1.0.0
 */
export declare class DasClient {
    private readonly t;
    /**
     ...
     * @since 1.0.0
     */
    getAsset(id: Pubkey, opts?: DasOpts & CallOptions): Promise<DasAsset>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetProof(id: Pubkey, opts?: DasOpts & CallOptions): Promise<DasAssetProof>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetBatch(ids: Pubkey[], opts?: DasOpts & CallOptions): Promise<DasAsset[]>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetProofBatch(ids: Pubkey[], opts?: DasOpts & CallOptions): Promise<Record<string, DasAssetProof>>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetsByOwner(params: m.GetAssetsByOwnerParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetsByGroup(params: m.GetAssetsByGroupParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetsByCreator(params: m.GetAssetsByCreatorParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
    /**
     ...
     * @since 1.0.0
     */
    getAssetsByAuthority(params: m.GetAssetsByAuthorityParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
    /**
     ...
     * @since 1.0.0
     */
    searchAssets(params: DasSearchParams, opts?: DasOpts & CallOptions): Promise<DasPage<DasAsset>>;
    /**
     ...
     * @since 1.0.0
     */
    getSignaturesForAsset(params: m.SignaturesForAssetParams, opts?: DasOpts & CallOptions): Promise<m.AssetSignaturesPage>;
    /**
     ...
     * @since 1.0.0
     */
    getTokenAccounts(params: m.GetTokenAccountsParams, opts?: DasOpts & CallOptions): Promise<m.TokenAccountsByOwnerResult>;
}
