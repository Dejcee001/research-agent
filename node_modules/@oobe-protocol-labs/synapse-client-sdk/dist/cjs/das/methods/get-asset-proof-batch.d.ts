 ...
 * @since 1.0.0
 */
export declare function getAssetProofBatch(t: HttpTransport, ids: Pubkey[], opts?: DasOpts & CallOptions): Promise<Record<string, DasAssetProof>>;
//# sourceMappingURL=get-asset-proof-batch.d.ts.map