...
exports.KNOWN_PROGRAMS_COUNT = exports.OTHER_PROGRAMS = exports.MARINADE_PROGRAMS = exports.METAPLEX_PROGRAMS = exports.ORCA_PROGRAMS = exports.METEORA_PROGRAMS = exports.RAYDIUM_PROGRAMS = exports.JUPITER_PROGRAMS = exports.SPL_PROGRAMS = exports.SYSTEM_PROGRAMS = exports.KNOWN_PROGRAMS = void 0;
exports.resolveProgram = resolveProgram;
exports.resolveProgramBatch = resolveProgramBatch;
exports.isProgramInCategory = isProgramInCategory;
exports.getProgramCategory = getProgramCategory;
/* ═══════════════════════════════════════════════════════════════
...
exports.SYSTEM_PROGRAMS = SYSTEM_PROGRAMS;
// ── SPL Token ──────────────────────────────────────────────────
const SPL_PROGRAMS = {
...
exports.SPL_PROGRAMS = SPL_PROGRAMS;
// ── Jupiter ────────────────────────────────────────────────────
...
exports.JUPITER_PROGRAMS = JUPITER_PROGRAMS;
// ── Raydium ────────────────────────────────────────────────────
...
exports.RAYDIUM_PROGRAMS = RAYDIUM_PROGRAMS;
// ── Meteora ────────────────────────────────────────────────────
...
exports.METEORA_PROGRAMS = METEORA_PROGRAMS;
// ── Orca ───────────────────────────────────────────────────────
const ORCA_PROGRAMS = {
...
exports.ORCA_PROGRAMS = ORCA_PROGRAMS;
// ── Metaplex / NFT ─────────────────────────────────────────────
const METAPLEX_PROGRAMS = {
...
exports.METAPLEX_PROGRAMS = METAPLEX_PROGRAMS;
// ── Marinade ───────────────────────────────────────────────────
const MARINADE_PROGRAMS = {
    'MarBmsSgKXdrN1egZf5sqe1TMai9K1rChYNDJgjq7aD': 'Marinade Finance',
    'MnDEuKqJpPm4YhDRig1GNiXoVpUMxfLCSKP7KuNMTxH': 'Marinade Native Staking',
};
exports.MARINADE_PROGRAMS = MARINADE_PROGRAMS;
 ...
 * @since 1.0.0
 */
function resolveProgram(programId, custom) {
    return custom?.[programId] ?? exports.KNOWN_PROGRAMS[programId];
}
/**
 ...
 * @since 1.0.0
 */
function resolveProgramBatch(programIds, custom) {
 ...
 * @since 1.0.0
 */
function isProgramInCategory(programId, category) {
    const registries = {
 ...
 * @since 1.0.0
 */
function getProgramCategory(programId) {
    if (programId in SYSTEM_PROGRAMS)
        return 'system';
    if (programId in SPL_PROGRAMS)
        return 'spl';
    if (programId in JUPITER_PROGRAMS)
        return 'jupiter';
    if (programId in RAYDIUM_PROGRAMS)
        return 'raydium';
    if (programId in METEORA_PROGRAMS)
        return 'meteora';
    if (programId in ORCA_PROGRAMS)
        return 'orca';
    if (programId in METAPLEX_PROGRAMS)
        return 'metaplex';
    if (programId in MARINADE_PROGRAMS)
        return 'marinade';
    if (programId in OTHER_PROGRAMS)
        return 'other';
    return 'unknown';
}
/** Total number of known programs. @since 1.0.0 */
exports.KNOWN_PROGRAMS_COUNT = Object.keys(exports.KNOWN_PROGRAMS).length;
