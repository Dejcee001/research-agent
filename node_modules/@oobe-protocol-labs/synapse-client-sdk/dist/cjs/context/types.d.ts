 ...
 * ```
 */
export declare function createToken<T>(name: string): ServiceToken<T>;
/**
 ...
 * @since 1.2.0
 */
export type ServiceProvider<T> = ValueProvider<T> | FactoryProvider<T> | ClassProvider<T> | AliasProvider<T> | AsyncFactoryProvider<T>;
/**
 ...
 * @since 1.2.0
 */
export declare class ServiceNotFoundError extends SynapseError {
 ...
 * @since 1.2.0
 */
export declare class CircularDependencyError extends SynapseError {
 ...
 * @since 1.2.0
 */
export declare class AsyncProviderError extends SynapseError {
    constructor(tokenName: string);
}
/**
